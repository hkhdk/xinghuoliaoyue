      ...
      <div class="side-bar">
        <ul class="channel-list">
          ...
          <li :class="activeLink == 1 ? 'active-channel' : ''" @click="toLink(1)">
            <Star style="width: 1em; height: 1em; margin-right: 8px" /><span class="channel"> 铭记</span>
          </li>
...
<!--                </div>-->
    ...
    <Login v-show="loginShow" @click-child="close" @register-handle="registerHandle"></Login>

    <Register v-show="registerShow" @click-child="registerHandle"></Register>
...
const routerList = ["/dashboard", "/followTrend", "/notice", "/push", "/user","/hero","/pushhero"];
...
const registerHandle = (val: boolean, val1: boolean) => {
  registerShow.value = val;
  if(!val1) loginShow.value = !val;
};
