    ...
    <div class="login-container">
      ...
      <div class="right">
          ...
          <form onsubmit="return false">
            <label class="phone">
              ...
              <input placeholder="输入手机号" type="text" name="blur" v-model="userLogin.username" /><svg
                class="reds-icon clear" width="24" height="24" fill="#xhs-pc-web-phone" style="display: none">
        ...
        <div class="login">
          ...
          <div class="login-common reg" @click="regShow">新用户注册</div>
        </div>
      </div>
    </div>
    <!---->
        ...
        <div class="reds-alert-content">
          ...
          <div data-v-44ecdae0-s="" class="alert-text">
            <a data-v-44ecdae0-s="" target="_blank"
               href="https://agree.xiaohongshu.com/h5/terms/ZXXY20220331001/-1">
              <!-- 《用户协议》 -->
            </a><a data-v-44ecdae0-s=""
                   target="_blank" href="https://agree.xiaohongshu.com/h5/terms/ZXXY20220509001/-1">
            <!-- 《隐私政策》 -->
          </a><br
...
const emit = defineEmits(["clickChild", "registerHandle"]);
const close = () => {
  //传递给父组件
