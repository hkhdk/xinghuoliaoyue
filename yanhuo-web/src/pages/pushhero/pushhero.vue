<template>
  ...
  <div class="container" id="container">
    ...
    <el-button color="red" @clink="toLink(3)" style="font-size: 17px; margin-left: 200px;">个人感悟</el-button>
    <el-button color="red" @clink="toLink(6)" style="font-size: 17px; ">英雄事迹</el-button>
    ...
    <div v-if="isLogin" class="push-container" id="tagContainer">
      ...
      <div class="push-content">
        <el-input v-model="note.title" maxlength="20" show-word-limit type="text" placeholder="请输入铭记烈士名称"
          class="input-title" />
        <textarea id="post-textarea" ref="postContent" class="post-content" contenteditable="true" data-tribute="true"
          placeholder="输入烈士事迹，如：
          &#10;性别:
          &#10;出生日期:
          &#10;籍贯:
          &#10;牺牲日期:
