<template>
  <div class="container" id="container">
    ...
    <div v-if="isLogin" class="push-container" id="tagContainer">
      ...
      <div class="header"><span class="header-icon"></span><span class="header-title">发布个人感悟</span></div>
      <div class="img-list">
