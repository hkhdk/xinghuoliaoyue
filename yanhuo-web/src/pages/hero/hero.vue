<template>
  <div class="feeds-page">
    ...
    <el-button color="red" @click="toLink(1)" style="font-size: 17px; margin-left: 150px;">个人动态</el-button>
    <el-button color="red" @click="toLink(5)" style="font-size: 17px; ">英雄人物</el-button>

    <div class="sidebar">
      <div class="channel-container">
        <div class="scroll-container channel-scroll-container">
          <div class="content-container">
            <div :class="'channel active'" v-for="item in city" @click="getCity_(item)">
              {{ item }}
            </div>
          </div>
        </div>
...
import { addRecord, getCity } from "@/api/search";
//import { getRecommendNotePage, getNotePageByDTO, addRecord, getCity } from "@/api/search";
...
const city = ["广州市", "深圳市", "珠海市", "汕头市", "佛山市", "韶关市", "揭阳市",
  "汕尾市", "惠州市", "梅州市", "潮州市", "河源市", "东莞市", "湛江市",
  "茂名市", "肇庆市", "清远市", "佛山市", "中山市", "江门市", "阳江市", "云浮市"];
...
const loadMoreData = () => {
  ...
  getCity(currentPage.value, pageSize, noteDTO.value).then((res) => {
    setData(res);
  });
};
...
const getCity_ = (city: string) => {  // city 就是城市名
  noteDTO.value.city = city
  noteDTO.value.cid = ""
  noteDTO.value.cpid = ""
