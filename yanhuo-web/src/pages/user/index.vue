      ...
      <div class="user-info">
        ...
        <div class="info-part">
          <div class="info">
            <div class="basic-info">
              <div class="user-basic">
                ...
                <div class="user-content">
                  <span class="user-redId">星火燎粤id：{{ userInfo.yxId }}</span
            ...
            <!-- {{ userInfo.id }}
{{ userGlobal!.id }} -->
            <div v-if="userInfo!.id === userGlobal!.id" class="data-info" style="justify-content: start;">
              <el-button @click="toEdit">编辑个人信息</el-button>
            </div>
  ...
  <eidtUserInfo v-if="dialogVisible" :dialogVisible="dialogVisible" @clickUserInfo="clickUserInfo"
                :userInfo="userInfo"></eidtUserInfo>
</template>

<script lang="ts" setup>
import eidtUserInfo from "./editUser.vue";
...
const userGlobal = computed(() => userStore.userInfo);
...
const clickUserInfo = (isConfirm: boolean, data: any)=> {
  console.log(isConfirm, data);
  if(data){
    userInfo.value = data;
