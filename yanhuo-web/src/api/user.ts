...
export const updateUser = (data: any) => {
  return request<any>({
    url: "/platform/user/updateUser", // mock接口
    method: "post",
    data: data,
...
export const getUserPageByKeyword = (currentPage: number, pageSize: number, keyword: string) => {
  return request<any>({
    url: `/platform/user/getUserPageByKeyword/${currentPage}/${pageSize}`, // mock接口
    method: "get",
    params: {
      keyword
    },
