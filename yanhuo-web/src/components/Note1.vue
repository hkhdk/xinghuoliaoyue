<template>
  ...
  :infinite-scroll-disabled="mainShow == true">
    <Waterfall
      :list="noteList"
      :width="options.width"
...
const setData = (res: any) => {
  const { records, total, size, pages } = res.data;
  // console.log(records, total);
  noteResPage.total = total;
  noteResPage.size = size;
  noteResPage.pages = pages;
...
const loadMoreData = () => {
  const pages = noteResPage.pages;
  // const size = noteResPage.size;
  // const total = Math.floor(Number(pages) / Number(size));
