...
public class NoteController {
    ...
    /*@PostMapping("getCity/{currentPage}/{pageSize}")
    @NoLoginIntercept
    public Result<?> getCity(@PathVariable long currentPage, @PathVariable long pageSize, @RequestBody NoteDTO noteDTO) {
        Page<NoteSearchVo> page = noteService.getCity(currentPage, pageSize, noteDTO);
        return Result.ok(page);
    }*/
